...
module.exports = {
	...
	actions: {
		...
		create(ctx) {
			...
			if(phone.startsWith("+26095") && phone.length !== 13 || phone.startsWith("26095") && phone.length !== 12 || phone.startsWith("095") && phone.length !== 10 || phone.startsWith("9") && phone.length !== 9 ){
				return {success:false,msg:"please provide a valid phone number. number must start with any of +260, 260, 09, 9"}
			}
